...
for (const course of coursesArray) {
    ...
    mainDiv.style.border = 'solid 2px red';
    mainDiv.style.padding = '10px';

    let titleElement = document.createElement('h2');
    titleElement.innerText = course.title;
    titleElement.style.border = 'solid 2px blue';
    ...
    monthDurationElement.style.border = 'solid 2px blue';
    ...
    hourDurationElement.style.border = 'solid 2px blue';
    hourDurationElement.style.width = '75%';


    let ul = document.createElement('ul')
    ul.style.border = 'solid 2px blue';
    ul.style.padding = '10px';

    for (const module of course.modules) {
        let li = document.createElement('li');
        li.innerText = module;
        li.style.border = 'solid 2px blue';
        li.style.margin = '5px'
    ...
    mainDiv.appendChild(durationWrap);
    durationWrap.appendChild(monthDurationElement);
    durationWrap.appendChild(hourDurationElement);
